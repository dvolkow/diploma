...
plot 'objs.txt' using 1:2 with p ps 0.1 lt rgb 'gray', 'rotc.txt' using 1:2 with l ls 1 lt rgb 'blue','sun.txt' using 1:2 with p ps 0.7 pt 7 lt rgb 'yellow' #'rotc.txt' using 1:3 with l ls 2 lt rgb 'red', 'rotc.txt' using 1:4 with l ls 2 lt rgb 'red', 
reset
