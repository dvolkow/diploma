...
do
#        mkdir ${i}
        ../diploma --file ../apogee-ucac.txt --solution vr --low-bound 10 --err 25 --upper-bound 40 --profile --bolter 1 --mksize $3 --ord ${i}
...
#        ../../sources/scripts/cur_plot.py 'vr_objs.txt' 'rotc.txt' 'sun.txt'
#        mv *.txt ${i}
#        mv *.png ${i}
        mv r0_bounds.txt ${i}
done 
